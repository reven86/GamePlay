    ...
    case EncoderArguments::FILEFORMAT_OTF:
        {
            ...
            writeFont(arguments.getFilePath().c_str(), arguments.getOutputFilePath().c_str(), fontSizes, id.c_str(), arguments.fontPreviewEnabled(), fontFormat, arguments.getCharacterSet().c_str( ));
            break;
        }
