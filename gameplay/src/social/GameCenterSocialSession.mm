            ...
            [player authenticateWithCompletionHandler:^(NSError *error)
            {
                ...
                else
                {
                    ...
                    if (error.code == GKErrorGameUnrecognized)
                        ...
                        listener->authenticateEvent(SocialSessionListener::ERROR_CANCEL, NULL);
                    else
                ...
                [GKPlayer loadPlayersForIdentifiers:friendIDs withCompletionHandler:^(NSArray *players, NSError *error)
                {
                    ...
                    else
                    {
                        ...
                        if (error.code == GKErrorInvalidParameter || error.code == GKErrorInvalidPlayer)
                            ...
                            _listener->loadFriendsEvent(SocialSessionListener::ERROR_CANCEL, _friends);
                        else
    ...
    [GKAchievement loadAchievementsWithCompletionHandler: ^(NSArray *awards, NSError *error)
     {
         ...
         else
         {
             ...
             if (error.code == GKErrorInvalidParameter || error.code == GKErrorInvalidPlayer)
                 ...
                 _listener->loadAchievementsEvent(SocialSessionListener::ERROR_CANCEL, _achievements);
             else
        ...
        [achievement reportAchievementWithCompletionHandler:^(NSError *error)
         {
             ...
             else
             {
                 ...
                 if (error.code == GKErrorInvalidParameter || error.code == GKErrorInvalidPlayer)
                     ...
                     _listener->submitAchievementEvent(SocialSessionListener::ERROR_CANCEL);
                 else
        ...
        [leaderboardRequest loadScoresWithCompletionHandler: ^(NSArray *scores, NSError *error)
         {
             ...
             else
             {
                 ...
                 if (error.code == GKErrorInvalidParameter || error.code == GKErrorInvalidPlayer)
                     ...
                     _listener->loadScoresEvent(SocialSessionListener::ERROR_CANCEL, _scores);
                 else
    ...
    [GKChallenge loadReceivedChallengesWithCompletionHandler:^(NSArray *challenges, NSError *error)
    {
        ...
        else
        {
            ...
            if (error.code == GKErrorInvalidParameter)
                ...
                _listener->loadChallengesEvent(SocialSessionListener::ERROR_CANCEL, _challenges);
            else
...
{
    return _listener->uiEvent(SocialSessionListener::ERROR_UNSUPPORTED);
}
