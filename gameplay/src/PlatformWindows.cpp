/*
    ...
    Changes to orginal document were done in lines: 14-1439.
*/
...
#define DEFAULT_ALPHA_BUFFER_SIZE 8
...
bool initializeGL(WindowCreationParams* params)
{
    ...
    pfd.cAlphaBits = DEFAULT_ALPHA_BUFFER_SIZE;
    ...
    int attribList[] = {
        ...
        WGL_ALPHA_BITS_ARB, DEFAULT_ALPHA_BUFFER_SIZE,
