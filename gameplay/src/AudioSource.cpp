/*
    ...
    Changes to orginal document were done in lines: 13, 259.
*/
...
void AudioSource::setOffsetInSeconds( float offset )
{
    AL_CHECK( alSourcei( _alSource, AL_SEC_OFFSET, offset ) );
}
