...
void luaRegister_JoystickControl()
{
    const luaL_Reg lua_members[] = 
    {
        ...
        {"getType", lua_JoystickControl_getType},
    ...
    ScriptUtil::registerClass("JoystickControl", lua_members, NULL, lua_JoystickControl__gc, lua_statics, scopePath);
}
...
static JoystickControl* getInstance(lua_State* state)
{
    ...
    return (JoystickControl*)((ScriptUtil::LuaObject*)userdata)->instance;
}
...
int lua_JoystickControl_getType(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_JoystickControl_getType - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
