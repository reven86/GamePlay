...
int lua_ProgressBar_addScript(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_addScript - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_clearScripts(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_clearScripts - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getScriptEvent(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getScriptEvent - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getTypeName(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getTypeName - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_hasScriptListener(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_hasScriptListener - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_removeScript(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_removeScript - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_resetAlignment(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_resetAlignment - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_setOrientation(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            {
                // Get parameter 1 off the stack.
                ProgressBar::OrientationType param1 = (ProgressBar::OrientationType)luaL_checkint(state, 2);
