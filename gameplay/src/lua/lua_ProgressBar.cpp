...
void luaRegister_ProgressBar()
{
    ...
    ScriptUtil::registerClass("ProgressBar", lua_members, NULL, lua_ProgressBar__gc, lua_statics, scopePath);
}

static ProgressBar* getInstance(lua_State* state)
{
    void* userdata = luaL_checkudata(state, 1, "ProgressBar");
    luaL_argcheck(state, userdata != NULL, 1, "'ProgressBar' expected.");
    return (ProgressBar*)((ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 1:
        {
            if ((lua_type(state, 1) == LUA_TUSERDATA))
            {
                ...
                if (object->owns)
                {
                    ProgressBar* instance = (ProgressBar*)object->instance;
            ...
            lua_pushstring(state, "lua_ProgressBar__gc - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_addListener(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 3:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_addListener - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_addRef(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_addRef - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_addScriptCallback(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 3:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_addScriptCallback - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_createAnimation(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 3:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_createAnimation - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 7:
...
int lua_ProgressBar_createAnimationFromBy(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 7:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_createAnimationFromBy - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_createAnimationFromTo(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 7:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_createAnimationFromTo - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_destroyAnimation(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_destroyAnimation - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 2:
...
int lua_ProgressBar_getAbsoluteBounds(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getAbsoluteBounds - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getAlignment(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getAlignment - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getAnimation(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getAnimation - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 2:
...
int lua_ProgressBar_getAnimationPropertyComponentCount(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getAnimationPropertyComponentCount - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getAnimationPropertyValue(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 3:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getAnimationPropertyValue - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getBorder(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getBorder - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 2:
...
int lua_ProgressBar_getBounds(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getBounds - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getClip(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getClip - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getClipBounds(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getClipBounds - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getConsumeInputEvents(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getConsumeInputEvents - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getCursorColor(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getCursorColor - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getCursorRegion(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getCursorRegion - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getCursorUVs(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getCursorUVs - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getFocusIndex(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getFocusIndex - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getFont(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getFont - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 2:
...
int lua_ProgressBar_getFontSize(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getFontSize - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 2:
...
int lua_ProgressBar_getHeight(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getHeight - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getId(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getId - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getImageColor(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 3:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getImageColor - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getImageRegion(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 3:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getImageRegion - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getImageUVs(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 3:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getImageUVs - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getMargin(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getMargin - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getOpacity(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getOpacity - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 2:
...
int lua_ProgressBar_getOrientation(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            {
                ProgressBar* instance = getInstance(state);
                ProgressBar::OrientationType result = instance->getOrientation();

                // Push the return value onto the stack.
                lua_pushstring(state, lua_stringFromEnum_ProgressBarOrientationType(result));

                return 1;
            }

            lua_pushstring(state, "lua_ProgressBar_getOrientation - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getPadding(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getPadding - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getRefCount(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getRefCount - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getSkinColor(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getSkinColor - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 2:
...
int lua_ProgressBar_getSkinRegion(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getSkinRegion - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 2:
...
int lua_ProgressBar_getState(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getState - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getStyle(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getStyle - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getTextAlignment(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getTextAlignment - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 2:
...
int lua_ProgressBar_getTextColor(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getTextColor - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 2:
...
int lua_ProgressBar_getValue(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getValue - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getWidth(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getWidth - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getX(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getX - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getY(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getY - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_getZIndex(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_getZIndex - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_isContainer(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_isContainer - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_isEnabled(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_isEnabled - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_release(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_release - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_removeListener(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_removeListener - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_removeScriptCallback(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 3:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_removeScriptCallback - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_setAlignment(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setAlignment - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_setAnimationPropertyValue(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 3:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setAnimationPropertyValue - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 4:
...
int lua_ProgressBar_setBorder(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 5:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setBorder - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 6:
...
int lua_ProgressBar_setConsumeInputEvents(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setConsumeInputEvents - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_setCursorColor(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 3:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setCursorColor - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_setCursorRegion(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 3:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setCursorRegion - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_setEnabled(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setEnabled - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_setFocusIndex(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setFocusIndex - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_setFont(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setFont - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 3:
...
int lua_ProgressBar_setFontSize(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setFontSize - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 3:
...
int lua_ProgressBar_setImageColor(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 3:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setImageColor - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 4:
...
int lua_ProgressBar_setImageRegion(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 3:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setImageRegion - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 4:
...
int lua_ProgressBar_setMargin(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 5:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setMargin - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_setOpacity(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setOpacity - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 3:
...
int lua_ProgressBar_setOrientation(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            {
                // Get parameter 1 off the stack.
                ProgressBar::OrientationType param1 = (ProgressBar::OrientationType)lua_enumFromString_ProgressBarOrientationType(luaL_checkstring(state, 2));

                ProgressBar* instance = getInstance(state);
                instance->setOrientation(param1);
                
                return 0;
            }

            lua_pushstring(state, "lua_ProgressBar_setOrientation - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_setPadding(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 5:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setPadding - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_setPosition(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 3:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setPosition - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_setSize(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 3:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setSize - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_setSkinColor(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setSkinColor - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 3:
...
int lua_ProgressBar_setSkinRegion(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setSkinRegion - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 3:
...
int lua_ProgressBar_setStyle(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setStyle - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_setTextAlignment(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setTextAlignment - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 3:
...
int lua_ProgressBar_setTextColor(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setTextColor - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 3:
...
int lua_ProgressBar_setValue(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setValue - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_setVisible(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setVisible - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_setZIndex(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_ProgressBar_setZIndex - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
int lua_ProgressBar_static_ANIMATE_OPACITY(lua_State* state)
{
    ...
    int result = ProgressBar::ANIMATE_OPACITY;
...
int lua_ProgressBar_static_ANIMATE_POSITION(lua_State* state)
{
    ...
    int result = ProgressBar::ANIMATE_POSITION;
...
int lua_ProgressBar_static_ANIMATE_POSITION_X(lua_State* state)
{
    ...
    int result = ProgressBar::ANIMATE_POSITION_X;
...
int lua_ProgressBar_static_ANIMATE_POSITION_Y(lua_State* state)
{
    ...
    int result = ProgressBar::ANIMATE_POSITION_Y;
...
int lua_ProgressBar_static_ANIMATE_SIZE(lua_State* state)
{
    ...
    int result = ProgressBar::ANIMATE_SIZE;
...
int lua_ProgressBar_static_ANIMATE_SIZE_HEIGHT(lua_State* state)
{
    ...
    int result = ProgressBar::ANIMATE_SIZE_HEIGHT;
...
int lua_ProgressBar_static_ANIMATE_SIZE_WIDTH(lua_State* state)
{
    ...
    int result = ProgressBar::ANIMATE_SIZE_WIDTH;
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                ...
                void* returnPtr = (void*)ProgressBar::create(param1, param2);
                if (returnPtr)
                {
                    ScriptUtil::LuaObject* object = (ScriptUtil::LuaObject*)lua_newuserdata(state, sizeof(ScriptUtil::LuaObject));
                    object->instance = returnPtr;
                    object->owns = true;
                    luaL_getmetatable(state, "ProgressBar");
                    lua_setmetatable(state, -2);
                }
                else
                {
            ...
            lua_pushstring(state, "lua_ProgressBar_static_create - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
