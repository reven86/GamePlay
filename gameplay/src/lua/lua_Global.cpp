...
void luaRegister_lua_Global()
{
    ...
    setHierarchyPair("Control", "ProgressBar");
    ...
    setHierarchyPair("HorizontalLayout", "Layout");
    ...
    setHierarchyPair("Layout", "HorizontalLayout");
    ...
    setHierarchyPair("ProgressBar", "Control");
    ...
    // Register enumeration Font::DrawFlags.
    {
        ...
        gameplay::ScriptUtil::registerEnumValue(Font::DRAW_VERTICAL_CW, "DRAW_VERTICAL_CW", scopePath);
    }
