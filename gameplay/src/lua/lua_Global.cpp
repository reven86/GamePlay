...
{
    ScriptUtil::registerFunction("strcmpnocase", lua__strcmpnocase);
    ...
    ScriptUtil::setGlobalHierarchyPair("AnimationTarget", "ImageControl");
    ScriptUtil::setGlobalHierarchyPair("AnimationTarget", "Joint");
    ScriptUtil::setGlobalHierarchyPair("AnimationTarget", "JoystickControl");
    ...
    ScriptUtil::setGlobalHierarchyPair("AnimationTarget", "ProgressBar");
    ...
    ScriptUtil::setGlobalHierarchyPair("Camera::Listener", "AudioListener");
    ScriptUtil::setGlobalHierarchyPair("Camera::Listener", "TerrainPatch");
    ...
    ScriptUtil::setGlobalHierarchyPair("Control", "ImageControl");
    ScriptUtil::setGlobalHierarchyPair("Control", "JoystickControl");
    ScriptUtil::setGlobalHierarchyPair("Control", "Label");
    ScriptUtil::setGlobalHierarchyPair("Control", "ProgressBar");
    ...
    ScriptUtil::setGlobalHierarchyPair("Layout", "HorizontalLayout");
    ...
    ScriptUtil::setGlobalHierarchyPair("Ref", "HorizontalLayout");
    ScriptUtil::setGlobalHierarchyPair("Ref", "Image");
    ScriptUtil::setGlobalHierarchyPair("Ref", "ImageControl");
    ScriptUtil::setGlobalHierarchyPair("Ref", "Joint");
    ScriptUtil::setGlobalHierarchyPair("Ref", "JoystickControl");
    ...
    ScriptUtil::setGlobalHierarchyPair("Ref", "ProgressBar");
    ...
    ScriptUtil::setGlobalHierarchyPair("ScriptTarget", "ImageControl");
    ScriptUtil::setGlobalHierarchyPair("ScriptTarget", "Joint");
    ScriptUtil::setGlobalHierarchyPair("ScriptTarget", "JoystickControl");
    ...
    ScriptUtil::setGlobalHierarchyPair("ScriptTarget", "ProgressBar");
    ...
    // Register enumeration Control::AutoSize.
    {
        std::vector<std::string> scopePath;
        scopePath.push_back("Control");
        ScriptUtil::registerConstantString("AUTO_SIZE_NONE", "AUTO_SIZE_NONE", scopePath);
        ScriptUtil::registerConstantString("AUTO_SIZE_WIDTH", "AUTO_SIZE_WIDTH", scopePath);
        ScriptUtil::registerConstantString("AUTO_SIZE_HEIGHT", "AUTO_SIZE_HEIGHT", scopePath);
        ScriptUtil::registerConstantString("AUTO_SIZE_BOTH", "AUTO_SIZE_BOTH", scopePath);
    }
    ...
    // Register enumeration Control::State.
    {
        ...
        ScriptUtil::registerConstantString("HOVER", "HOVER", scopePath);
    }
    ...
    // Register enumeration Font::Format.
    {
        ...
        ScriptUtil::registerConstantString("BITMAP", "BITMAP", scopePath);
        ScriptUtil::registerConstantString("DISTANCE_FIELD", "DISTANCE_FIELD", scopePath);
    }
    ...
    // Register enumeration Font::Style.
    {
        ...
        ScriptUtil::registerConstantString("TEXTURED", "TEXTURED", scopePath);
    }
    ...
    // Register enumeration Gesture::GestureEvent.
    {
        ...
        ScriptUtil::registerConstantString("GESTURE_LONG_TAP", "GESTURE_LONG_TAP", scopePath);
        ScriptUtil::registerConstantString("GESTURE_DRAG", "GESTURE_DRAG", scopePath);
        ScriptUtil::registerConstantString("GESTURE_DROP", "GESTURE_DROP", scopePath);
    ...
    // Register enumeration Layout::Type.
    {
        ...
        ScriptUtil::registerConstantString("LAYOUT_HORIZONTAL", "LAYOUT_HORIZONTAL", scopePath);
    }
    ...
    // Register enumeration ProgressBar::OrientationType.
    {
        std::vector<std::string> scopePath;
        scopePath.push_back("ProgressBar");
        ScriptUtil::registerConstantString("ORIENTATION_HORIZONTAL", "ORIENTATION_HORIZONTAL", scopePath);
        ScriptUtil::registerConstantString("ORIENTATION_VERTICAL", "ORIENTATION_VERTICAL", scopePath);
    }
    ...
    // Register enumeration RenderState::CullFaceSide.
    {
        std::vector<std::string> scopePath;
        scopePath.push_back("RenderState");
        ScriptUtil::registerConstantString("CULL_FACE_SIDE_BACK", "CULL_FACE_SIDE_BACK", scopePath);
        ScriptUtil::registerConstantString("CULL_FACE_SIDE_FRONT", "CULL_FACE_SIDE_FRONT", scopePath);
        ScriptUtil::registerConstantString("CULL_FACE_SIDE_FRONT_AND_BACK", "CULL_FACE_SIDE_FRONT_AND_BACK", scopePath);
    }
    ...
    // Register enumeration RenderState::StencilFunction.
    {
        std::vector<std::string> scopePath;
        scopePath.push_back("RenderState");
        ScriptUtil::registerConstantString("STENCIL_NEVER", "STENCIL_NEVER", scopePath);
        ScriptUtil::registerConstantString("STENCIL_ALWAYS", "STENCIL_ALWAYS", scopePath);
        ScriptUtil::registerConstantString("STENCIL_LESS", "STENCIL_LESS", scopePath);
        ScriptUtil::registerConstantString("STENCIL_LEQUAL", "STENCIL_LEQUAL", scopePath);
        ScriptUtil::registerConstantString("STENCIL_EQUAL", "STENCIL_EQUAL", scopePath);
        ScriptUtil::registerConstantString("STENCIL_GREATER", "STENCIL_GREATER", scopePath);
        ScriptUtil::registerConstantString("STENCIL_GEQUAL", "STENCIL_GEQUAL", scopePath);
        ScriptUtil::registerConstantString("STENCIL_NOTEQUAL", "STENCIL_NOTEQUAL", scopePath);
    }
    ...
    // Register enumeration RenderState::StencilOperation.
    {
        std::vector<std::string> scopePath;
        scopePath.push_back("RenderState");
        ScriptUtil::registerConstantString("STENCIL_OP_KEEP", "STENCIL_OP_KEEP", scopePath);
        ScriptUtil::registerConstantString("STENCIL_OP_ZERO", "STENCIL_OP_ZERO", scopePath);
        ScriptUtil::registerConstantString("STENCIL_OP_REPLACE", "STENCIL_OP_REPLACE", scopePath);
        ScriptUtil::registerConstantString("STENCIL_OP_INCR", "STENCIL_OP_INCR", scopePath);
        ScriptUtil::registerConstantString("STENCIL_OP_DECR", "STENCIL_OP_DECR", scopePath);
        ScriptUtil::registerConstantString("STENCIL_OP_INVERT", "STENCIL_OP_INVERT", scopePath);
        ScriptUtil::registerConstantString("STENCIL_OP_INCR_WRAP", "STENCIL_OP_INCR_WRAP", scopePath);
        ScriptUtil::registerConstantString("STENCIL_OP_DECR_WRAP", "STENCIL_OP_DECR_WRAP", scopePath);
    }
    ...
    // Register enumeration TextBox::InputMode.
    {
        ...
        ScriptUtil::registerConstantString("TEXT", "TEXT", scopePath);
...
const char* lua_stringFromEnumGlobal(std::string& enumname, unsigned int value)
{
    ...
    if (enumname == "ProgressBar::OrientationType")
        return lua_stringFromEnum_ProgressBarOrientationType((ProgressBar::OrientationType)value);
