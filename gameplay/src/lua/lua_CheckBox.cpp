...
static int lua_CheckBox_getCharacterSpacing(lua_State* state)
{
    // Get the number of parameters.
    int paramCount = lua_gettop(state);
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_CheckBox_getCharacterSpacing - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 2:
...
static int lua_CheckBox_getContentBounds(lua_State* state)
{
    // Get the number of parameters.
    int paramCount = lua_gettop(state);
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_CheckBox_getContentBounds - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
static int lua_CheckBox_getIconScale(lua_State* state)
{
    // Get the number of parameters.
    int paramCount = lua_gettop(state);
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_CheckBox_getIconScale - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
static int lua_CheckBox_getLineSpacing(lua_State* state)
{
    // Get the number of parameters.
    int paramCount = lua_gettop(state);
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_CheckBox_getLineSpacing - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 2:
...
static int lua_CheckBox_getReceiveInputEvents(lua_State* state)
{
    // Get the number of parameters.
    int paramCount = lua_gettop(state);
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_CheckBox_getReceiveInputEvents - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
static int lua_CheckBox_getTextDrawingFlags(lua_State* state)
{
    // Get the number of parameters.
    int paramCount = lua_gettop(state);
...
static int lua_CheckBox_resetAlignment(lua_State* state)
{
    // Get the number of parameters.
    int paramCount = lua_gettop(state);
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            lua_pushstring(state, "lua_CheckBox_resetAlignment - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
static int lua_CheckBox_setCharacterSpacing(lua_State* state)
{
    // Get the number of parameters.
    int paramCount = lua_gettop(state);
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_CheckBox_setCharacterSpacing - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 3:
...
static int lua_CheckBox_setIconScale(lua_State* state)
{
    // Get the number of parameters.
    int paramCount = lua_gettop(state);
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_CheckBox_setIconScale - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
static int lua_CheckBox_setLineSpacing(lua_State* state)
{
    // Get the number of parameters.
    int paramCount = lua_gettop(state);
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_CheckBox_setLineSpacing - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        case 3:
...
static int lua_CheckBox_setReceiveInputEvents(lua_State* state)
{
    // Get the number of parameters.
    int paramCount = lua_gettop(state);
    ...
    switch (paramCount)
    {
        case 2:
        {
            ...
            lua_pushstring(state, "lua_CheckBox_setReceiveInputEvents - Failed to match the given parameters to a valid function signature.");
            lua_error(state);
            break;
        }
        default:
...
static int lua_CheckBox_setTextDrawingFlags(lua_State* state)
{
    // Get the number of parameters.
    int paramCount = lua_gettop(state);
...
static int lua_CheckBox_static_ANIMATE_SKIN_COLOR(lua_State* state)
{
    // Validate the number of parameters.
    if (lua_gettop(state) > 0)
    {
    ...
    int result = CheckBox::ANIMATE_SKIN_COLOR;
...
static int lua_CheckBox_static_ANIMATE_TEXT_COLOR(lua_State* state)
{
    // Validate the number of parameters.
    if (lua_gettop(state) > 0)
    {
    ...
    int result = CheckBox::ANIMATE_TEXT_COLOR;
...
void luaRegister_CheckBox()
{
    const luaL_Reg lua_members[] = 
    {
        ...
        {"getCharacterSpacing", lua_CheckBox_getCharacterSpacing},
        ...
        {"getContentBounds", lua_CheckBox_getContentBounds},
        ...
        {"getIconScale", lua_CheckBox_getIconScale},
        ...
        {"getLineSpacing", lua_CheckBox_getLineSpacing},
        ...
        {"getReceiveInputEvents", lua_CheckBox_getReceiveInputEvents},
        ...
        {"resetAlignment", lua_CheckBox_resetAlignment},
        ...
        {"setCharacterSpacing", lua_CheckBox_setCharacterSpacing},
        ...
        {"setReceiveInputEvents", lua_CheckBox_setReceiveInputEvents},
    ...
    const luaL_Reg lua_statics[] = 
    {
        ...
        {"ANIMATE_SKIN_COLOR", lua_CheckBox_static_ANIMATE_SKIN_COLOR},
        {"ANIMATE_TEXT_COLOR", lua_CheckBox_static_ANIMATE_TEXT_COLOR},
