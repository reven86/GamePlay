/*
    ...
    Changes to orginal document were done in lines: 1736, 1766, 1798, 1811.
*/
...
Font* Bundle::loadFont(const char* id)
{
    ...
    for (unsigned int i = 0; i < fontSizeCount; ++i)
    {
        ...
        Texture* texture = Texture::create(style == Font::TEXTURED ? Texture::RGBA : Texture::ALPHA, width, height, textureData, false);
        ...
        Font* font = Font::create(family.c_str(), static_cast< Font::Style >( style ), size, glyphs, glyphCount, texture, (Font::Format)format);
